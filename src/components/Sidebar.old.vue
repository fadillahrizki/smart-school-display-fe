    ...
    <div :class="isOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
      ...
      <nav class="mt-10">
        ...
        <router-link class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          ...
          <span class="mx-4">Jadwal Pelajaran</span>
        </router-link>
        ...
        <router-link class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          ...
          <span class="mx-4">Pengumuman Sekolah</span>
        </router-link>
        ...
        <router-link class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          ...
          <span class="mx-4">Guru Piket</span>
        </router-link>
        ...
        <router-link class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          ...
          <span class="mx-4">Agenda Kegiatan</span>
        </router-link>
        ...
        <router-link class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          ...
          <span class="mx-4">Notifikasi Darurat</span>
        </router-link>
      </nav>
    </div>
  </div>
