...
<template>
  <div>
    ...
    <div class="mt-4">
      ...
      <div class="mt-4">
        <div class="w-full max-w-sm overflow-hidden bg-white rounded-md shadow-md">
          <form>
            <div class="flex items-center justify-between px-5 py-3 text-gray-700">
              <h3 class="text-sm">
                Add Category
              </h3>
              <button>
            ...
            <div class="px-5 py-6 text-gray-700 bg-gray-200">
              ...
              <div class="relative mt-2 rounded-md shadow-sm">
                ...
                <input type="text"
                  class="w-full px-12 py-2 border bg-white border-gray-200 rounded-md appearance-none focus:border-indigo-600 focus:ring focus:ring-opacity-40 focus:ring-indigo-500">
              </div>
            </div>
